...
class Utilities extends Model {
	...
	public static function get_uag_forms() {
		...
		$sql_query = "SELECT `ID`, `post_content`, `post_title` FROM {$model->table} WHERE post_status = 'publish' AND post_type in ( 'page', 'post' ) AND post_content LIKE '%%wp-block-uagb-forms%%'";
